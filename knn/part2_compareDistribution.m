...
[fullTrainingSet, ~] = dataExtraction('GenreClassData_30s.txt');
...
%% Build training set of selected features
...
subplot(224);
histogram(popSet(:,4),10); hold on;
histogram(metalSet(:,4),10);
histogram(discoSet(:,4),10);
histogram(classicalSet(:,4),10);
title('Tempo');

set(fig1,'position',[500,500,800,500])
hgexport(fig1, 'figs/part2_histograms_byFt.eps');